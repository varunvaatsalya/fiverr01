...
function Page() {
  ...
  return (
    <div className="bg-gray-800 w-1/2 min-h-screen p-4 flex flex-col items-center justify-center">
      <div className="w-60">
        <ImageDropUploader imageId={imageId} setImageId={setImageId} />
      </div>
    </div>
  );
}
// uploads/temp/1753627185178_WIN_20230529_22_12_35_Pro.jpg
