...
function Page() {
  const Works = [
    ...
    //   link: "/dashboard-admin/hospitalPharmacy/retails/works",
    //   color: "bg-blue-800",
    // },
    {
      name: "Stock Info",
      ...
      link: "/dashboard-admin/hospitalPharmacy/retails/retailStock",
      color: "bg-lime-700",
    },
    {
      name: "Stock Request",
    ...
    //   link: "/dashboard-admin/hospitalPharmacy/retails/stockExpiring",
    //   color: "bg-amber-700",
    // },
    // {
    //   name: "Stock Edit",
    ...
    //   link: "/dashboard-admin/hospitalPharmacy/retails/stockEdit",
