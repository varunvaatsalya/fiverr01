                  ...
                  <div className="w-full px-3 pb-3 bg-gray-200 rounded-b-xl ">
                    ...
                    <div className="flex justify-start items-center gap-2 mt-3">
                      {accessInfo?.accessRole === "admin" ? (
                        <button
                          className="py-2 px-4 text-white bg-red-600 disabled:bg-gray-600 rounded-lg font-semibold flex gap-1 items-center"
                          onClick={() => {
                      ...
                      ):<div className="text-red-600">Contact admin to delete the invoice.</div>}
                    </div>
                  </div>
                )}
              </div>
