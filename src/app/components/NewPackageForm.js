...
function NewPackageForm({ setNewUserSection, setPackages }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (result.success) {
        setPackages((prevPackages) => [result.newPackage, ...prevPackages]);
          ...
          <div className="w-[95%] md:w-3/4 py-4 text-center bg-slate-950 px-4 rounded-xl">
            ...
            >
              ...
              <h2 className="font-bold text-2xl text-white">
                Details of new <span className="text-blue-500">Package</span>
              </h2>
