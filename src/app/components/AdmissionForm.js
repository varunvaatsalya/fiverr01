...
function AdmissionForm({ bed, setBed }) {
  ...
  return (
    <>
      <div className="bg-gray-800 text-gray-100 flex justify-center gap-4 py-2 w-full text-xl rounded-full mx-auto md:w-3/5 lg:w-[45%]">
        <div className="">
          Patient:{" "}
      ...
      <div className="bg-gray-700 text-gray-100 my-2 w-full mx-auto md:w-3/4 p-2 rounded-xl">
      ...
      <div className="bg-gray-700 text-gray-100 my-2 w-full mx-auto md:w-3/4 rounded-xl">
        <div
          onClick={() => {
