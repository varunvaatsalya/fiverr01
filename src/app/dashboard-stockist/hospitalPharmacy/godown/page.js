  ...
  const Works = [
    {
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/purchaseInvoices",
      color: "bg-sky-800",
    },
    {
      name: "New Stocks",
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/newStock",
      color: "bg-orange-800",
    },
    {
      name: "Stock Info",
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/godownStock",
    ...
    },
    {
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/godownStockRequest",
      color: "bg-amber-800",
    },
    // {
    //   name: "Stock Edit",
    ...
    //   icon: <FaEdit size={50} />,
    //   link: "/dashboard-stockist/hospitalPharmacy/godown/editGodownStock",
    //   color: "bg-violet-700",
    // },
    {
      name: "Payments Dues",
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/purchaseDueInvoices",
      color: "bg-red-900",
    },
    {
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/stockExpiring",
      color: "bg-green-800",
    },
    {
      name: "Stock Order",
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/stockOrder",
      color: "bg-amber-800",
    },
    {
      ...
      link: "/dashboard-stockist/hospitalPharmacy/godown/stockOrderHistory",
      color: "bg-purple-700",
    },
  ];
